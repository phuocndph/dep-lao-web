...
import type { CRMContact, CRMNote } from '@deplao/store/crmStore';
import type { LabelData } from '@deplao/store/appStore';
...
import LocalLabelSelector from '@deplao/components/common/LocalLabelSelector';
import type { LocalLabelItem } from '@deplao/components/common/LocalLabelSelector';
import NoteList from '../notes/NoteList';
import PhoneDisplay from '@deplao/components/common/PhoneDisplay';
import type { PinnedNote } from '@deplao/components/chat/PinnedMessages';
