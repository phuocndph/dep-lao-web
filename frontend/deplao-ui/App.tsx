...
import AddAccountModal from "@deplao/components/auth/AddAccountModal";
import EmployeeConnectionBanner from "@deplao/components/common/EmployeeConnectionBanner";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (channel === 'facebook') {
      ...
      import('@deplao/lib/fbInitUtils').then(({ checkFBAccountInitNeeds }) => {
